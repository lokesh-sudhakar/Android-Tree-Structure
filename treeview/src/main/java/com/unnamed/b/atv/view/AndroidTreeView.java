...
public class AndroidTreeView {
    ...
    public View getView(int style) {
        ...
        final DragLinearLayout viewTreeItems = new DragLinearLayout(containerContext,null,containerStyle);
//        final LinearLayout viewTreeItems = new LinearLayout(containerContext, null, containerStyle);
        ...
        for(int i = 0; i < viewTreeItems.getChildCount(); i++){
            View child = viewTreeItems.getChildAt(i);
            // the child will act as its own drag handle
            viewTreeItems.setViewDraggable(child, child);
        }
        viewTreeItems.setOnViewSwapListener(new DragLinearLayout.OnViewSwapListener() {
            @Override
